...
const Resume = ({ mode = 'default' }) => {
  const isSolutions = mode === 'solutions';
  // If solutions mode, use emil_resume.pdf. Otherwise, use the original emil_william_resume.pdf
  const resumeFile = isSolutions ? "/emil_resume.pdf" : "/emil_william_resume.pdf";
